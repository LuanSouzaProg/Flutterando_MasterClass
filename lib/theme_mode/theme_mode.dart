...
class MyThemes{
  static final darkTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.dark(primary: Color(0xFF055AA3), secondary: Color(0xFFEDF4FB)),
    textSelectionTheme: const TextSelectionThemeData(selectionColor: Color(0xFFEDF4FB)),
    bottomAppBarColor: const Color(0xFFEDF4FB),
  );
  ...
  static final lightTheme = ThemeData(
    ...
    primaryColor: const Color(0xFF055AA3),
    iconTheme: const IconThemeData(color: Color(0xFFEDF4FB)),
    colorScheme: const ColorScheme.light(primary: Color(0xFF055AA3), secondary: Color(0xFF172026)),
    textSelectionTheme: const TextSelectionThemeData(selectionColor: Color(0xFF121517)),
    bottomAppBarColor: const Color(0xFF121517),
  );
}